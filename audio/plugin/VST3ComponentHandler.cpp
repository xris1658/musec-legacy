...
{
VST3ComponentHandler::VST3ComponentHandler(Musec::Audio::Plugin::VST3Plugin* plugin):
    plugin_(plugin),
    paramIdAndIndex_()
{}

Steinberg::tresult VST3ComponentHandler::queryInterface(const Steinberg::int8* iid, void** obj)
{
...
Steinberg::tresult VST3ComponentHandler::setDirty(Steinberg::TBool state)
{
    return Steinberg::kNotImplemented;
}

Steinberg::tresult VST3ComponentHandler::requestOpenEditor(Steinberg::FIDString name)
{
...
Steinberg::tresult VST3ComponentHandler::startGroupEdit()
{
    return Steinberg::kNotImplemented;
}

Steinberg::tresult VST3ComponentHandler::finishGroupEdit()
{
    return Steinberg::kNotImplemented;
}
}