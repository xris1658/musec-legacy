...
template<> inline const char*     noteNameArray<char,     MIDINoteNameKeyShift::Sharp>() { return charNoteNameWithSharp; }
template<> inline const char*     noteNameArray<char,     MIDINoteNameKeyShift::Flat>() { return charNoteNameWithFlat; }
template<> inline const wchar_t*  noteNameArray<wchar_t,  MIDINoteNameKeyShift::Sharp>() { return wideCharNoteNameWithSharp; }
template<> inline const wchar_t*  noteNameArray<wchar_t,  MIDINoteNameKeyShift::Flat>() { return wideCharNoteNameWithFlat; }
template<> inline const char16_t* noteNameArray<char16_t, MIDINoteNameKeyShift::Sharp>() { return u16CharNoteNameWithSharp; }
template<> inline const char16_t* noteNameArray<char16_t, MIDINoteNameKeyShift::Flat>() { return u16CharNoteNameWithFlat; }
template<> inline const char32_t* noteNameArray<char32_t, MIDINoteNameKeyShift::Sharp>() { return u32CharNoteNameWithSharp; }
template<> inline const char32_t* noteNameArray<char32_t, MIDINoteNameKeyShift::Flat>() { return u32CharNoteNameWithFlat; }
...
template<> inline const char8_t* const _noteNameArray<char8_t, AudioEngine::KeyShift::Sharp>() { return u8CharNoteNameWithSharp; }
template<> inline const char8_t* const _noteNameArray<char8_t, AudioEngine::KeyShift::Flat>() { return u8CharNoteNameWithFlat; }
#endif
}
