#ifndef MUSEC_UTIL_TIMERCLAMP
#define MUSEC_UTIL_TIMERCLAMP
...
std::tuple<ReturnType, std::int64_t> timerClamp(Function&& function, Args&&... args)
{
...
std::int64_t timerClampVoid(Function<void, Args...>&& function, Args&&... args)
{
    auto start = Musec::Native::currentTimeInNanosecond();
